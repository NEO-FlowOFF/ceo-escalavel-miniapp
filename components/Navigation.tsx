  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full max-w-lg mx-auto ios-blur bg-[#0a050f]/80 border-t border-[#ffffff10] px-4 pt-3 pb-[calc(12px+env(safe-area-inset-bottom))] flex justify-between items-center z-[70]">
      ...
      >
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest leading-none">Ops</span>
      </button>
      ...
      >
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest leading-none">Agents</span>
      </button>
      ...
      >
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest leading-none">Docs</span>
      </button>
      ...
      >
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest leading-none">X-Ray</span>
      </button>
    </nav>
  );
};
